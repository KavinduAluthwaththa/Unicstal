...
export const useManifestAnimations = () => {
  ...
  useEffect(() => {
    ...
    // Scroll-based exit animation (slide to the RIGHT side - opposite of hero)
    gsap.to(container, {
      xPercent: 150, // Positive value for right slide (opposite of hero's -150)
      opacity: 0,
      scrollTrigger: {
        trigger: "#section-three", // Target section 3 as trigger
        start: "top bottom",
        end: "top 80%",
        scrub: 1,
