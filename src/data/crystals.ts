...
export const crystalData: Crystal[] = [
  {
    ...
    full_description: 'Rainbow Moonstone is a stunning variety of labradorite that exhibits brilliant flashes of blue, green, and gold. Known as the stone of the goddess, it connects you deeply to lunar energies and divine feminine wisdom. This mystical crystal enhances psychic abilities, promotes lucid dreaming, and helps you navigate life transitions with grace and intuition.',
  ...
  },
  {
    ...
    slug: 'moldavite',
    full_description: 'Moldavite is a rare tektite formed from a meteorite impact in the Czech Republic approximately 15 million years ago. Known as the "Stone of Transformation," Moldavite carries intense frequency that can catalyze rapid spiritual evolution and consciousness expansion. This cosmic glass is highly sought after for its ability to accelerate personal growth and connect with star wisdom.',
  ...
  },
  {
    ...
    full_description: 'Labradorite is renowned as the stone of magic and transformation. This mystical feldspar mineral displays spectacular labradorescence - flashes of blue, green, gold, and purple that seem to hold the Northern Lights within. Labradorite awakens psychic abilities, protects the aura, and helps you discover your magical potential and unique gifts.',
